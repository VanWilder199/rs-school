...
export let cardsInnerClass: { actionA: cardsAction[], actionB: cardsAction[],
  outdoors: cardsAction[], house: cardsAction[], animalA: cardsAction[], animalB: cardsAction[],
  clothes: cardsAction[], emotion: cardsAction[] };
cardsInnerClass = {
  actionA: [
    {
      word: 'cry',
...
export class AppComponent {
  constructor(private CardsService: CardsService, public GameService: GameService, public BaseService: BaseService) {
    CardsService.toggleActiveLink();
